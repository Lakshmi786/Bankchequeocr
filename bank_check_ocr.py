...
cv2.imwrite(r'C:\Users\Laksan\Downloads\bank-check-ocr-master\bank-check-ocr-master\bbox1.png',clone)
...
for (name, roi, loc) in zip(charNames, refROIs, refLocs):
	...
	chars[name] = roi
	cv2.imwrite(r'C:\Users\Laksan\Downloads\bank-check-ocr-master\bank-check-ocr-master\bbox2.png',clone)
